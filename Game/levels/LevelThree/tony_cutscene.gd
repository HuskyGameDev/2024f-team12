...
func _send_text():
	...
	text_box.queue_cutscene("Moreau", 0, "\"I see, so that’s what this has been about this whole time then, dirty money.\"")
	...
	text_box.queue_cutscene("Tony", 0, "\"He mentioned that aside from loan sharking, they will do just about anything for a buck or a favor.\"")
